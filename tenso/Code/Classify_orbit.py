...
#load the data#
data=np.loadtxt(r'../Data/case1_classification.dat',delimiter=' ',dtype='float')
...
x_train0=mdata[0:np.int64(dataSet_size*0.9),:]
x_train=scaler.fit_transform(x_train0)

x_val0=mdata[np.int64(dataSet_size*0.9): np.int64(dataSet_size*0.95),:]
x_val=scaler.transform(x_val0)
x_test0=mdata[np.int64(dataSet_size*0.95): np.int64(dataSet_size),:]
x_test=scaler.transform(x_test0)

status_train0=status[0:np.int64(dataSet_size*0.9)]
status_val0=status[np.int64(dataSet_size*0.9): np.int64(dataSet_size*0.95)]
status_test0=status[np.int64(dataSet_size*0.95): np.int64(dataSet_size*1)]
...
model_path1='../Model/case1_classify_model.h5' 
